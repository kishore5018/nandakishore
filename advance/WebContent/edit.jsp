...
PreparedStatement pstmt=conn.prepareStatement("select * from employee1 where username=?");
pstmt.setString(1, username);
ResultSet rs=pstmt.executeQuery();
boolean req=rs.next();
%>
<form action="updateservlet" method="post">
UserName:::<input type="text" name="username" value=<%=rs.getString("username") %>  readonly="readonly"><br><br>
